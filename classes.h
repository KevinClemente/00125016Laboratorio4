...
enum parameters {ELEMENT_LENGTH,VAR_J,VAR_K,VAR_LAMBDA,VAR_L,VAR_M,VAR_ALPHA,VAR_N,VAR_P};
...
class mesh{
    ...
    public:
        void setParameters(float l,float J,float K,float LAMBDA,float L,float M,float ALFA,float N,float P){
            parameters[ELEMENT_LENGTH]=l;
            parameters[VAR_J]=J;
            parameters[VAR_K]=K;
            parameters[VAR_LAMBDA]=LAMBDA;
            parameters[VAR_L]=L;
            parameters[VAR_M]=M;
            parameters[VAR_ALPHA]=ALFA;
            parameters[VAR_N]=N;
            parameters[VAR_P]=P;
        }
